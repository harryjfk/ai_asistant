...
var gracefulFs = patch(clone$1(fs$C));
...
function copyDir$2 (src, dest, opts) {
  const dir = fs$w.opendirSync(src);

  try {
    let dirent;

    while ((dirent = dir.readSync()) !== null) {
      copyDirItem$2(dirent.name, src, dest, opts);
    }
  } finally {
    dir.closeSync();
  }
...
function requireNode_cache () {
	...
	(function() {
	  ...
	  EventEmitter = require$$1$2.EventEmitter;
...
const { isMainThread } = require$$1$3;
...
const fluent_ffmpeg_1$1 = __importDefault$5(require$$0$a);
const fs_extra_1$2 = lib$3;
const os_1$2 = require$$0$8;
...
const fluent_ffmpeg_1 = __importDefault$4(require$$0$a);
const fs_extra_1$1 = lib$3;
const os_1$1 = require$$0$8;
...
const sharp_1 = __importStar(require$$0$b);
